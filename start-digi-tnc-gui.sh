...
xfce4-terminal --minimize --title UDPGATE4 -e 'bash -c "udpgate4 -s $MYCALL -R 127.0.0.1:9299:10201+10:0#144800 -H 10080 -I 1440 -u 50 -B 60 -O -n 30:$DXLPATH/netbeacon.txt -g $SERVERURL:$SERVERPORT#m/100,-t/t,-u/APLWS*/APRARX -p $PASSCODE -t 14580 -w 14501 -v -D /home/pi/dxlAPRS/aprs/www/ -0 -v"' &
